...
public class MessageListAdapter extends BaseAdapter
{
    ...
    public void udpate(Conversation conversation)
    {
        udpate(conversation, false);
    }
     ...
     * 
     * @param conversation 
     * @param first <code>True</code> if we are in the constructor.
     */
    private final void udpate(Conversation conversation, boolean first) 
    {
        if (!first)
            messages.clear();
